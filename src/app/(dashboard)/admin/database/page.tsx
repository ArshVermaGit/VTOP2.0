...
import { Database, HardDrive, Network, Server, RefreshCw, Activity } from "lucide-react"
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
         <div>
            <h1 className="text-3xl font-bold text-white tracking-tight flex items-center gap-3">
               <Database className="w-8 h-8 text-emerald-400" /> Database Hub
            </h1>
            <p className="text-gray-400 mt-1">Direct access to PostgreSQL primary and replica nodes</p>
         </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
         <StatsCard label="Active Connections" value="342" icon={Network} color="emerald" />
         <StatsCard label="Query Latency" value="12ms" icon={ActivityIcon} color="blue" />
